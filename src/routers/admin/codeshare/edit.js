...
console.log("[DisList.Me]: Admin/CodeShare/Edit router loaded.");
...
app.post("/admin/editcode/:code", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(global.config.server.channels.codelog).send(new Discord.MessageEmbed()
        ...
        .setDescription(`The user named **[${req.user.username}](https://dislist.me/user/${req.user.id})** edited the code named **${rBody['codename']}**.`)
        .addField("Code Link", `https://dislist.me/code/${kod}`, true)
