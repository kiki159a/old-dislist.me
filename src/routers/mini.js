...
app.get("/vanity/:username", async (req,res) => {
    ...
    res.redirect('https://www.dislist.me/bot/'+botdata.botID)
})
...
app.get("/robots.txt", function(req, res) {
    ...
    res.send(`Sitemap: https://www.dislist.me/sitemap.xml`);
});

app.get("/sitemap.xml", async function(req, res) {
    let link = "<url><loc>https://www.dislist.me/</loc></url>";
    let botdataforxml = await botsdata.find()
    botdataforxml.forEach(bot => {
        link += "\n<url><loc>https://www.dislist.me/bot/" + bot.botID + "</loc></url>";
    })
